    ...
    public class RequirementController : ControllerBase
    {
        ...
        public IActionResult ConfirmPrice([FromBody] int requirementId)
        {
            try
            {
                ...
                {
                    if (design.MasterGemstone == null)
                    {
                        requirement.MasterGemStonePriceAtMoment = 0;
                    }
                    if (design.Stone == null)
                    {
                        requirement.StonePriceAtMoment = 0;
                    }
                    if (design.Material == null)
                    {
                        requirement.MaterialPriceAtMoment = 0;
                    }
                    requirement.MasterGemStonePriceAtMoment = design.MasterGemstone.Price;
                    requirement.StonePriceAtMoment = design.Stone.Price;
                    requirement.MaterialPriceAtMoment = design.Material.Price;
                    requirement.Status = "4";
                    requirement.TotalMoney = (decimal?)(design.Material.Price + design.MasterGemstone.Price + design.Stone.Price) + requirement.MachiningFee;
