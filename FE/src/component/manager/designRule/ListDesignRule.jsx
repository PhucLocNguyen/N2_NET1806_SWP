  ...
  const getDesignRule = async (page, search = "") => {
    ...
    if (search) {
      const filteredData = response.filter(
        (item) =>
          item.designRuleId.toLowerCase().includes(search.toLowerCase()) ||
          item.minSizeMasterGemstone
            .toString()
            .toLowerCase()
            .includes(search.toLowerCase()) ||
          item.maxSizeMasterGemstone
            .toString()
            .toLowerCase()
            .includes(search.toLowerCase()) ||
          item.minSizeJewellery.toLowerCase().includes(search.toLowerCase()) ||
          item.maxSizeJewellery
            .toString()
            .toLowerCase()
            .includes(search.toLowerCase()) ||
          item?.typeOfJewellery?.typeOfJewelleryId
            .toLowerCase()
            .includes(search.toLowerCase())
      );
