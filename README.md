...
This repository contains the Jewelry Production Order System for the SWP391-NET1806 course in SUMMER2024. The Jewelry Production Ordering System is a new software solution designed to replace the current manual process of ordering and picking up jewelry directly at shops. The system is intended to evolve through multiple releases, eventually integrating Internet ordering services with online payment capabilities.
...
1. Clone the repository:
   ```sh
   https://github.com/PhucLocNguyen/N2_NET1806_SWP.git
